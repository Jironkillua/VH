...
function whenVillageIsFound(array, arguments, receivedMessage) {
...
function removeVillagetimerCommand(arguments, receivedMessage) {
    ...
    removeVillage(arguments, receivedMessage)
...
function removeVillage(arg, receivedMessage) {
    ...
    if (whenVillageIsFound(villageCommunity, arg, receivedMessage)) {


        console.log("remove " + villageCommunity[posIndex] + " " + posIndex)
        villageCommunity.splice(posIndex, 1)
        clearInterval(villageTimeCommunity[posIndex])
        clearInterval(villageTime6hCommunity[posIndex])
        clearInterval(villageTime2hCommunity[posIndex])
        clearInterval(villageTime30minCommunity[posIndex])
        clearInterval(villageTime10minCommunity[posIndex])
        villageTimeCommunity.splice(posIndex, 1)
        villageTime6hCommunity.splice(posIndex, 1)
        villageTime2hCommunity.splice(posIndex, 1)
        villageTime30minCommunity.splice(posIndex, 1)
        villageTime10minCommunity.splice(posIndex, 1)
...
function addVillage(args, receivedMessage) {
    ...
    if (!whenVillageIsFound(villageCommunity, args, receivedMessage)) {
...
function updateVillagetimer(args, msg) {
    ...
    if (whenVillageIsFound(villageCommunity, args, msg)) {


        console.log("update timer " + villageCommunity[posIndex][0] + " " + posIndex)
        villageCommunity.splice(posIndex, 1)
        clearInterval(villageTimeCommunity[posIndex])
